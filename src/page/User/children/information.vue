    ...
    <y-shelf title="账户资料">
      <div slot="content">
        ...
        <div class="avatar-box">
          <div class=img-box><img :src="userInfo.info.avatarUrl" alt=""></div>
          <div class="r-box">
          ...
          <y-shelf title="修改昵称">
            ...
            <div slot="content" class="content">
              ...
              <div class="bootom-btn pa">
                ...
                <el-button @click="saveUsername({userId:userId, username: nickVer.nick})" type="primary" :disabled="verNick ? false : true"  style="width: 140px; height: 40px;">
                  确定
                </el-button>
              </div>
            </div>
          ...
          <y-shelf title="修改密码">
            ...
            <div slot="content" class="content">
              ...
              <div class="bootom-btn pa">
                ...
                <el-button @click="updatePass({userId:userId,password: passVer.newPass})" type="primary" :disabled="vOPass && vNPass && vRPass ? false : true"  style="width: 140px; height: 40px;">
                  确定
                </el-button>
              </div>
            </div>
          ...
          <y-shelf title="安全验证">
            ...
            <div slot="content" class="content">
              ...
              <div class="bootom-btn pa">
                ...
                <el-button @click="_updateEmail({userId:userId, email: VerEmailTwo.email})" type="primary" :disabled="verEmailTwoEmail & verEmailTwoCode ? false : true"  style="width: 140px; height: 40px;">
                  确认
                </el-button>
              </div>
            </div>
...
<script>
  ...
  import { upload, updateheadimage, updateUser, loginOut, sendEmailCode} from '/api/index'
  ...
  import { checkPhone, checkEmail } from '/api/index'
  import md5 from 'js-md5'
  export default {
    data () {
      // 验证昵称
      var vNick = (rule, value, callback) => {
        if (!value) {
          this.verNick = false
      ...
      return {
        ...
        nickVerRules: {
          nick: [
            {validator: vNick, trigger: 'change'}
          ]
        },
        popupOpen2: false,
        popupTitle2: '',
        ...
        VerRules: {
          verCode: [
            {validator: vCode, trigger: 'change'}
          ]
        },
        verNick: false,
        vvCode: false,
        ...
        phoneRules: {
          phone: [
            {validator: vPhone, trigger: 'change'}
          ],
          verCode: [
            {validator: vVerCode, trigger: 'change'}
          ]
        },
        verPhone: false,
        sendAuth: true,
        ...
        passRules: {
          ...
          newPass: [
            {validator: vNewPass, trigger: 'blur'}
          ],
          rePass: [
        ...
        VerEmailOneRules: {
          verCode: [
            {validator: vEmailOneCode, trigger: 'blur'}
          ]
        },
        ...
        VerEmailTwoRules: {
          email: [
            {validator: vEmailTwoEmail, trigger: 'change'}
          ],
          verCode: [
            {validator: vEmailTwoCode, trigger: 'change'}
          ]
        },
    ...
    methods: {
      ...
      // 保存用户名
      async saveUsername (params) {
        this.editNickShow = false
        const res = await updateUser(params)
        if(res.status !==0){
          this.messageFail(res.msg)
        }
        this.userTxt = res.data.username
      ...
      async sendEmailOne () {
        ...
        this.verEmailOneCode = res.data
        this.messageSuccess("验证码发送成功，请查看邮箱！")
      },
      // 邮箱安全验证通过，下一步
      verEmailNext () {
        this.$refs['VerEmailTwo'].resetFields()
